            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                <div className="flex">
                    ...
                    Object.keys(variants["red"]).includes(size) && (
                      <button
                        className={`border-2 ml-1 bg-red-700 rounded-full w-6 h-6 focus:outline-none ${
                          color == "red" ? "border-gray-900" : "border-gray-300"
                        }`}
                  ...
                  {Object.keys(variants).includes("indigo") &&
                    Object.keys(variants["indigo"]).includes(size) && (
                      <button
                        className={`border-2  ml-1 bg-indigo-700 rounded-full w-6 h-6 focus:outline-none ${
                          color == "indigo"
                            ? "border-gray-900"
                            : "border-gray-300"
                        }`}
                        onClick={(e) => refreshVariant(size, "indigo")}
                      ></button>
                    )}
